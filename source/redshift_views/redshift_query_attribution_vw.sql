...
select count(1) as node_count
      ...
      ,1 as price_per_node_per_hour                                                     -- Modify this based on the price per hour of the compute node (Check https://aws.amazon.com/redshift/pricing/) ra3.4xlarge, $3.26 per Hour, config it on apollo
      ...
      ,cast(count(1) 
      * 1                                                                               -- Modify this based on the price per hour of the compute node (Check https://aws.amazon.com/redshift/pricing/) ra3.4xlarge, $3.26 per Hour, config it on apollo
